  ...
  return (
    <div className="fixed flex items-center justify-center inset-0 z-10 bg-black/30">
        <div className='flex flex-col items-center bg-[#0F1035] px-12 py-8 rounded-xl'>
            ...
            <textarea name="" id="" rows="4" placeholder='Megjegyzés' className='px-2 py-1 mt-5 rounded-lg w-full resize-none outline-none text-black'></textarea>
            <div className='flex gap-2.5 mt-6'>
                <button className='px-5 py-2 rounded-lg bg-[#365486]/100 hover:bg-[#365486]/75 transition-colors'>Értékelés leadása</button>
